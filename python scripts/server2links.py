...
if '__main__' == __name__:
  ...
  h1.cmd("ifconfig h1-eth1 mtu 576")
  ...
  r1.cmd('bash -c "sleep 1; xterm -e \'tcpdump -i r1-eth2 -w dataout.pcap\' &"')
  h2.cmd('bash -c "sleep 1; xterm -e \'iperf -s -i 1\' &"')
  #h1.cmd('bash -c "sleep 1; xterm -e \'iperf -c 10.0.2.2 -t 10 -i 1\' &"')
  h1.cmd('bash -c "sleep 1; xterm -e \'iperf -c 10.0.2.2 -n 500M\' &"')
  #h1.cmd('bash -c "sleep 1; xterm -e \'iperf -c 10.0.2.2 -t 10 -i 1 > mptcp_dis_9000.txt\' &"')
