...
if '__main__' == __name__:
  ...
  r1.cmd("ifconfig r1-eth1 mtu 576")
  ...
  r1.cmd('bash -c "sleep 1; xterm -e \'tcpdump -i r1-eth2 -w dis2.pcap\' &"')
  h2.cmd('bash -c "sleep 1; xterm -e \'iperf -s -i 1\' &"')
  h1.cmd('bash -c "sleep 1; xterm -e \'iperf -c 10.0.2.2 -n 500M -i 1 > dis_res2.txt\' &"')
  #h1.cmd('bash -c "sleep 1; xterm -e \'iperf -c 10.0.2.2 -t 10 -n 500M ' &"')
  #h1.cmd('bash -c "sleep 1; xterm -e \'iperf -c 10.0.2.2 -t 10 -i 1 > mptcp_en_bw_unset.txt\' &"')
